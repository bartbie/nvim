describe("Test env", function()
    ...
    it("can access treesitter parsers", function()
        require("spec.helpers").assert_grammar("fennel")
        require("spec.helpers").assert_grammar("clojure")
        require("spec.helpers").assert_grammar("janet")
        require("spec.helpers").assert_grammar("lua")
    end)
end)
